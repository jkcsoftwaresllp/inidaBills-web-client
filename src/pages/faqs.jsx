...
const faqs = [
  {
    ...
    answer:
      'IndiaBills is a comprehensive inventory and billing software designed to simplify the management of sales, purchases, and inventory for businesses of all sizes. It helps businesses streamline processes, manage stock levels, and generate invoices with user-friendly tools.',
  },
  {
    question: 'How do I install IndiaBills?',
    answer:
      'You can download IndiaBills from your play store or any browser on your device.',
  },
  {
    question: 'What are the minimum system requirements for IndiaBills?',
    answer:
      'To run IndiaBills smoothly, you just need our application or a web browser on your smartphone or PC with a stable internet connection.',
  },
  {
    question: 'How can I create an account on IndiaBills?',
    answer:
      'Visit the registration page on our website, enter your details, and verify your email to get started.',
  },
  {
    question: 'Is IndiaBills suitable for small businesses?',
    answer:
      'Yes, IndiaBills is perfect for SMEs. It provides easy-to-use features that help manage inventory and billing without technical expertise.',
  },
  {
    question: 'What is inventory management software?',
    answer:
      'Inventory management software like IndiaBills helps businesses track stock levels, manage orders, and organize data, reducing errors and saving time.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, IndiaBills is accessible on mobile devices through our responsive web interface.',
  },
  {
    question: 'What types of businesses can use IndiaBills?',
    answer:
      'IndiaBills is suitable for retail stores, wholesalers, manufacturers, service providers, and more.',
  },
  {
    question: 'Is my data safe with IndiaBills?',
    answer:
      'Yes, your data is protected with SSL encryption and regular backups, ensuring only authorized access.',
  },
  {
    question: 'How much does a billing software cost?',
    answer:
      'IndiaBills offers affordable pricing plans starting from basic packages with premium features.',
  },
  {
    question:
      'Can I generate an invoice on credit, card, UPI, or other payment types?',
    answer:
      'Yes, IndiaBills supports multiple payment types including credit, card, UPI, and other customizable options.',
  },
  {
    question: 'Can IndiaBills handle multiple currencies?',
    answer:
      'Yes, it supports multi-currency transactions for international clients.',
  },
  {
    question: 'How can IndiaBills help with tax compliance?',
    answer:
      'It automatically calculates GST and other taxes, ensuring accurate and compliant invoicing.',
  },
  {
    question: 'Does IndiaBills support barcode scanning?',
    answer:
      'Yes, IndiaBills integrates with barcode scanners for easy stock entry and product tracking.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, it offers customizable invoice templates, reports, and user roles.',
  },
  {
    question: 'How does IndiaBills handle returns and refunds?',
    answer:
      'You can issue credit notes and update inventory automatically through the software.',
  },
  {
    question: 'Does IndiaBills support recurring billing?',
    answer:
      'Yes, automated recurring invoices can be set up for subscription billing.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, it supports POS integration and real-time inventory tracking.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Go to the inventory section and adjust prices individually or in bulk.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Use the invoice editor to design invoices with your logo, colors, and format.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Sales, purchases, inventory, GST summaries, and customizable reports.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, discounts can be applied on invoices and customized per product or client.',
  },
  {
    question: 'How does IndiaBills help in reducing billing errors?',
    answer:
      'Automated calculations and template-based invoicing reduce human errors.',
  },
  {
    question:
      'What is the difference between free and paid versions of IndiaBills?',
    answer:
      'Free offers basic features, while paid versions include premium reports, multi-user support, and customization.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'IndiaBills allows you to export data in formats like Excel, CSV, or PDF, making it easy to share with accountants or import into other software.',
  },
];
  ...
  return (
    <div className={styles.container}>
      ...
      <div style={{ display: 'none' }}>
        <h1>IndiaBills FAQ - Frequently Asked Questions</h1>
        <h2>India Bills Help and Support</h2>
        <h3>IndiaBills Common Questions</h3>
        <h4>India Bills User Guide</h4>
        <p>Find answers to common questions about IndiaBills billing software. India Bills FAQ covers all your queries about our software.</p>
      </div>
      ...
      <div className={styles.supportSection}>
        <h2>Still have questions about IndiaBills?</h2>
