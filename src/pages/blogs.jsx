...
const blogPosts = [
  {
    ...
    excerpt: 'Everything you need to know about GST billing software, compliance requirements, and how IndiaBills simplifies tax management for Indian businesses.',
  ...
  },
  {
    ...
    excerpt: 'Learn proven inventory management strategies that help small businesses reduce costs, prevent stockouts, and improve cash flow with IndiaBills.',
    author: 'Priya Sharma',
    date: '2025-01-12',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt: 'How Indian retailers are leveraging digital billing and inventory solutions like IndiaBills to compete in the modern marketplace.',
    author: 'Rajesh Kumar',
    date: '2025-01-10',
    readTime: '7 min read',
  ...
  },
  {
    ...
    excerpt: 'Manage multiple business locations efficiently with centralized billing, inventory tracking, and reporting using IndiaBills software.',
    author: 'Vikram Singh',
    date: '2025-01-05',
    readTime: '5 min read',
  ...
  },
  {
    ...
    excerpt: 'Discover how automated billing systems like IndiaBills reduce errors, save time, and improve cash flow for businesses across India.',
    author: 'Meera Patel',
    date: '2025-01-03',
    readTime: '6 min read',
    category: 'Automation',
  ...
  },
  {
    ...
    excerpt: 'Explore the advantages of cloud-based accounting solutions and why IndiaBills cloud platform is perfect for modern Indian businesses.',
    author: 'Arjun Reddy',
    date: '2025-01-01',
    readTime: '7 min read',
  ...
  },
  {
    ...
    excerpt: 'Detailed comparison of IndiaBills with other billing software in India, highlighting unique features and value propositions.',
    author: 'IndiaBills Team',
    date: '2024-12-28',
  ...
  return (
    <div className={styles.container}>
      <section className={styles.hero}>
        <h1>IndiaBills Blog</h1>
        <p>
          Stay updated with the latest insights on billing software, inventory management, 
          GST compliance, and business growth strategies for Indian enterprises.
        </p>
      </section>
      ...
      {featuredPost && (
        <section className={styles.featuredSection}>
          ...
          <Link to={`/blog/${featuredPost.slug}`} className={styles.featuredPost}>
